  ...
  children: [
    {
      ...
      children: [
        ...
        { name: "CEH V10", path: "/cyber/ec/ceh-v10" },
...

{
  ...
  name: "Data Science",
  children: [
    { name: "Alteryx", path: "/data-science/alteryx" }
  ]
},
  ...
  children: [
    {
      name: "NetSuite",
      children: [
        { name: "Master Self-Paced", path: "/newest/netsuite" }
      ]
    },

    {
      name: "Informatica",
      children: [
        { name: "Master Self-Paced", path: "/newest/informatica" }
      ]
    },

    {
      name: "RPA",
      children: [
        { name: "Master Self-Paced", path: "/newest/rpa" }
      ]
    },

    {
      name: "PEGA",
      children: [
        { name: "Master Self-Paced", path: "/newest/pega" }
      ]
    },

    {
      name: "IAM",
      children: [
        { name: "Master Self-Paced", path: "/newest/iam" }
      ]
    }
  ]
},
    ...
    children: [
      ...
      },
      {
          ...
          children: [
            ...
            { name: "Professional Workflow", path: "/canal/workflow" },
          ],
        },
    ],
  },
